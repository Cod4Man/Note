...
![1614075810740](img\JVM内存结构图.png)
...
- 栈中存储的是什么
  ...
  ![1614076678103](img\栈的栈帧元素存储的信息.png)
...
![1614077381249](img\栈帧-局部变量表.png)
...
![1614085724615](img\栈帧-操作数栈执行过程.png)
...
![1614086764326](img\Java堆的分类.png)
