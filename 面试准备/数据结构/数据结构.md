...
fast-fail 机制，在操作时发现count和预期的不一致。

https://blog.csdn.net/u013833031/article/details/108756109
...
![1620725666009](img\HashMap的remove题目.png)
...
### 6.4 computeIfPresent

有值时插入，如果插入的value为null，则removeKey
...
![1620693701429](img\LinkedHashMap底层机制.png)
...
![1621517969401](img\二叉搜索树从上投影是有序的.png)
...
4. **插入的节点父节点为红色（主要逻辑）**
   ...
   **原则，需要按上述步骤(步骤4)重新处理爷爷节点(当前节点)**
   ...
   ![1621522103363](img\红黑树插入场景4.1.png)
   ...
   ![1621522448525](img\红黑树插入场景4.2.1LLr左左红.png)
   ...
   ![1621522482217](img\红黑树插入场景4.2.2LRr左右红.png)
   ...
   ![1621522816908](img\红黑树插入场景4.3.1RLr右左红.png)
   ...
   ![1621522992698](img\红黑树插入场景4.3.2RRr右右红.png)

- 插入示意图

  ![1621523189811](img\红黑树插入示意图.png)

#### 13.3.6 代码实现

- 代码层面分析

![1621559265799](img\红黑树插入逻辑代码分析.png)
